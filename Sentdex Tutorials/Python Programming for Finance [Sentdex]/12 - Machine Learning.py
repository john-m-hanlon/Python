...
def extract_feature_sets(ticker):
    ...
    =======
    X : float
        The daily percent change for each ticker

    y : str
        The label for each ticker

    df : dataframe
        The dataframe that is being evaluated, for reference purposes
    '''
...
def do_machine_learning(ticker):
    '''
    Runs the machine learning analysis
